...
describe('#mutations', () => {
  describe('#SET_CONTACTS', () => {
    it('set contact records', () => {
      ...
      mutations[types.SET_CONTACTS](state, [
        { id: 2, name: 'contact2', email: 'contact2@chatwoot.vn' },
        { id: 1, name: 'contact1', email: 'contact1@chatwoot.vn' },
      ]);
      expect(state.records).toEqual({
        1: {
          id: 1,
          name: 'contact1',
          email: 'contact1@chatwoot.vn',
        },
        2: {
          id: 2,
          name: 'contact2',
          email: 'contact2@chatwoot.vn',
        },
      });
  ...
  describe('#SET_CONTACT_ITEM', () => {
    it('push contact data to the store', () => {
      const state = {
        records: {
          1: { id: 1, name: 'contact1', email: 'contact1@chatwoot.vn' },
        },
        sortOrder: [1],
      };
      ...
      expect(state.records).toEqual({
        1: { id: 1, name: 'contact1', email: 'contact1@chatwoot.vn' },
        2: { id: 2, name: 'contact2', email: 'contact2@chatwoot.vn' },
      });
  ...
  describe('#EDIT_CONTACT', () => {
    it('update contact', () => {
      ...
      expect(state.records).toEqual({
        1: { id: 1, name: 'contact2', email: 'contact2@chatwoot.vn' },
      });
    });
  });
